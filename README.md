...
### Cointegration:
 ...
 ```
 Where,
 $n$ is the hedge ratio (It is ideal when $\mathrm{Spread} = 0$)
...
5. Define $\displaystyle Z_{\rm entry}^{\rm upper} = 2.0,\quad Z_{\rm entry}^{\rm lower} = -2.0,\quad Z_{\rm exit} = 0.0$
6. When $Z-score$ crosses $Z_{\rm entry}^{\rm upper}$, go SHORT. <br>
Close the position when $Z-score$ returns to $Z_{\rm exit}$.
7. When $Z-score$ crosses $Z_{\rm entry}^{\rm lower}$, go LONG. <br>
Close the position when $Z-score$ returns to $Z_{\rm exit}$.
...
1. Calculate $$Spread = Y –\ hedgeRatio * X$$
...
5. Define $\displaystyle Z_{\rm entry}^{\rm upper} = 1.25,\quad Z_{\rm entry}^{\rm lower} = -1.25,\quad Z_{\rm exit} = -0.5$
6. When $Z-score$ crosses $Z_{\rm entry}^{\rm upper}$, go SHORT. <br>
Close the position when $Z-score$ returns to $Z_{\rm exit}$.
7. When $Z-score$ crosses $Z_{\rm entry}^{\rm lower}$, go LONG. <br>
Close the position when $Z-score$ returns to $Z_{\rm exit}$.
...
Where,
- $R_p$: The average return of the investment or portfolio.
- $R_f$: The risk-free rate of return.
- $\sigma_p$: The standard deviation of the investment's or portfolio's returns.
...
$$\mathrm{CAGR} = \Bigl(\tfrac{\text{Ending Value}}{\text{Beginning Value}}\Bigr)^{1/n} - 1$$
Where,
- $\text{Ending Value}$ = Value of the asset at the end of the specified time period.
- $\text{Beginning Value}$ = initial value of the asset at the beginning of the specified time period. 
